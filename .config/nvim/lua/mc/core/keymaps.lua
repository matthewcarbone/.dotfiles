...
-- BufTabLine shortcuts for navigating the buffers
keymap.set("n", "<leader>1", "<Plug>BufTabLine.Go(1)")
keymap.set("n", "<leader>2", "<Plug>BufTabLine.Go(2)")
keymap.set("n", "<leader>3", "<Plug>BufTabLine.Go(3)")
keymap.set("n", "<leader>4", "<Plug>BufTabLine.Go(4)")
keymap.set("n", "<leader>5", "<Plug>BufTabLine.Go(5)")
keymap.set("n", "<leader>6", "<Plug>BufTabLine.Go(6)")
keymap.set("n", "<leader>7", "<Plug>BufTabLine.Go(7)")
keymap.set("n", "<leader>8", "<Plug>BufTabLine.Go(8)")
keymap.set("n", "<leader>9", "<Plug>BufTabLine.Go(9)")
keymap.set("n", "<leader>0", "<Plug>BufTabLine.Go(10)")
